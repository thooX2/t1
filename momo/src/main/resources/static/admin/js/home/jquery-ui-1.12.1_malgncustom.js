...
function Datepicker() {
	...
	this.regional[ "" ] = { // Default regional settings
		...
		currentText: "오늘 날짜", // Display text for current month link
		clearText: "지우기",
	...
	this._defaults = { // Global defaults for all the date picker instances
		...
		showAnim: "", // Name of jQuery animation for popup - default:fadeIn
		...
		showCurrentAtPos: 1, // The position in multipe months at which to show the current month (starting at 0)
...
$.extend( Datepicker.prototype, {
	...
	_showDatepicker: function( input ) {
		...
		// CHH 2021-02-05 adjust size when window small
		//if ( 0 > offset.left) {
		//	offset.left = 0;
	...
	_checkOffset: function( inst, offset, isFixed ) {
		...
		// CHH 2021-02-05 adjust size when window small
		//if(dpWidth > viewWidth) offset.left = -1;
	...
	_attachHandlers: function( inst ) {
		...
		inst.dpDiv.find( "[data-handler]" ).map( function() {
			var handler = {
				prev: function() {
					$.datepicker._adjustDate( id, -stepMonths - numberOfMonths + showCurrentAtPos + 1, "M" );
				},
				next: function() {
					$.datepicker._adjustDate( id, +stepMonths - numberOfMonths + showCurrentAtPos + 1, "M" );
				},
				...
				today: function() {
					date = new Date();
					//$.datepicker._selectDay( id, inst.currentMonth, inst.currentYear, inst.currentDay );
					$.datepicker._selectDate( id, $.datepicker._formatDate( inst, date.getDate(), date.getMonth(), date.getFullYear() ) );
	...
	_generateHTML: function( inst ) {
		var maxDraw, prevText, prev, nextText, next, currentText, clearText, gotoDate,
		...
		buttonPanel = ( showButtonPanel ) ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" + ( isRTL ? controls : "" ) +
			...
			">" + currentText + "</button><button type='button' class='ui-datepicker-clear ui-state-default ui-priority-secondary ui-corner-all' data-handler='clear' data-event='click'" +
		...
		for ( row = 0; row < numMonths[ 0 ]; row++ ) {
			...
			for ( col = 0; col < numMonths[ 1 ]; col++ ) {
				...
				calender += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + cornerClass + "'>" +
					...
					row > 0 || col != showCurrentAtPos, monthNames, monthNamesShort ) + // draw month headers, default secondary condition: row > 0 || col > 0
