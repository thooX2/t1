...
function initTinyMCE(obj) {
	...
	tinymce.init({
		...
		toolbar: "fontselect | fontsizeselect | bold italic underline strikethrough blockquote | forecolor backcolor | bullist numlist outdent indent | alignleft aligncenter alignright alignjustify | table link"
				+ (modal ? " image media |" : "")
				+ " removeformat code fullscreen",
