document.addEventListener('DOMContentLoaded', function() {
	let selectedSubject = "smjrcc1";
	document.getElementById('smjcc').addEventListener('click', function() {
		selectedSubject = this.value;
		const detailSubjectSelect = document.getElementById('smicc');
